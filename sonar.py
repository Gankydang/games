...
def drawBoard(board):
    ...
    tenDigitsLine = '    ' # Initial space for the numbers down the lefr side of the board.
    for i in range(1, 6):
        tenDigitsLine += (' ' * 9) + str(i)

    # Print the numbers across the top of the baord.
    print(tenDigitsLine)
    print('   ' + ('0123456789' * 6))
    print()
...
def getRandomChests(numChests):
    # Creats a list of chest data structures (two-item lists of x, y int coordinates).
    chests = []
...
def makeMove(board, chests, x, y):
    ...
    # Otherwise, return the srting of the result of this move.
...
def showInstructions():
    print('''Instructions:
You are the captian of the Simon, a treasure-hunting ship. Your current mission
...
while True:
    ...
    while sonarDevices > 0:
        ...
        if len(theChests) == 0:
            print('You have found all the snken treasure chests! Congradulations and good game!')
            break
